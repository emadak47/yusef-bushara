        ...
        <div className='my-16'>
            ...
            <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2 '>
                    <Details
                        position="Bushara, Yusef. “Dancing Feet: Emergence”. antilang, No.10. 13 October 2021."
                    ...
                    />
                    <Details
                        position="Bushara, Yusef. “Refuge at Giza”. The Foundationalist, Vol.7. Issue No.2. Fall 2022."
                        company="TPS Capital"
